...
if (isset($_POST['username']) && isset($_POST['password'])) {
	...
	$num = mysqli_num_rows(mysqli_query($myConnection, "SELECT * FROM tb_akun_manajemen WHERE user_manajemen='$username' and pass_manajemen='$enc' and status_manajemen = 'aktif' and soft_delete = 0 "));
	if ($num > 0) {
		echo 1;
	} else {
		echo 0;
