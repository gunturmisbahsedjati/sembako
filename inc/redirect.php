...
$num = mysqli_query($myConnection, "SELECT * FROM tb_akun_manajemen WHERE user_manajemen='$username' and pass_manajemen='$enc' and status_manajemen = 'aktif' and soft_delete = 0 ");
...
$_SESSION['arrayKabKotaInstansi'] = $akun['id_kabkota'];
